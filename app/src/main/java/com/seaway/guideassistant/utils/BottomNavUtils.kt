...
object BottomNavUtils {
    ...
    fun initTabNavi(activity:AppCompatActivity,tabLayout: TabLayout, viewPager2: ViewPager2,tabs:List<TabNavBottomBean>,fragments:List<Fragment>, cb:((Int)->Unit)?=null){
        ...
        tabs.forEachIndexed {i,item->
            ...
            iv.setImageResource(if (i==0)item.iconSelect else item.iconUnSelect)
            //图标为装饰性元素，文字已朗读tab名称，避免TalkBack重复播报
            iv.importantForAccessibility = View.IMPORTANT_FOR_ACCESSIBILITY_NO
            tab.customView = view
