...
import com.seaway.guideassistant.module.LoadDialog
import com.seaway.guideassistant.utils.L
import com.seaway.guideassistant.utils.showToast
...
abstract class OnDataSuccessListener<T : Any> constructor(dialog: LoadDialog? = null, refreshLayout: SwipeRefreshLayout?) : DisposableObserver<T>(), OnErrorCallback {
