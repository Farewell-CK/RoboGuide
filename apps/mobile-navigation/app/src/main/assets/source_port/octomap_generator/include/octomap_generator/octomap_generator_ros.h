...
#include <std_msgs/Empty.h> // added by lixuan 2 Apr. 2023
...
class OctomapGeneratorNode{
  ...
  protected:
    ...
    ros::Publisher heartbeat_pub_;  // added by lixuan 2 Apr. 2023
    ...
    bool global_crop_; ///whether to crop the octomap by max_range
  };
