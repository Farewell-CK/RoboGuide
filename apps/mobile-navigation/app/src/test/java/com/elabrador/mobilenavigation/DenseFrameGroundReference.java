...
final class DenseFrameGroundReference {
    ...
    private DenseFrameGroundReference() {}
    ...
    static Result apply(SemanticPointCloud.Data cloud, float[] cameraToWorld,
        ...
        boolean[] observed = new boolean[cellCount];
        int[] observedCells = new int[cellCount];
        int observedCount = 0;
        ...
        for (int point = 0; point < pointCount; point++) {
            ...
            if (bin >= 0) {
                binCells[bin * cellCount + cell] = true;
                if (!observed[cell]) {
                    observed[cell] = true;
