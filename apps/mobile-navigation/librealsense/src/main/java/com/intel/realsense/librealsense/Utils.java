...
public class Utils {
    ...
    /**
     * Deprojects into caller-owned storage. This is equivalent to the allocating
     * overload and is intended for dense point-cloud loops.
     */
    public static void deprojectPixelToPoint(final Intrinsic intrinsic, final Pixel pixel,
                                             final float depth, final Point_3D output) {
        nDeprojectPixelToPoint(output, intrinsic, pixel, depth);
    }
