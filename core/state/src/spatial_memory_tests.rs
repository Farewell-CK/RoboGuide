//! Spatial Memory projection tests.

use super::*;
use domain::{
    ContentDigest, EventId, EventPayload, ExecutionGroupId, LocalizationFrames,
    LocalizationVerificationEvidence, MapArtifactRef, MapId, MapRevisionId, MapRevisionSelector,
    MissionId, NodeId, PoseQualityComparison, PoseQualityEvidence, RoleId, SpatialAnchorId, TaskId,
    TaskRef,
};
