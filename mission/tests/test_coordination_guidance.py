...
def test_all_deliberation_paths_receive_the_same_coordination_contract() -> None:
    ...
    for requirement in (
        ...
        "Choose the smallest logical participant set",
        "One Actor may own multiple independent Tasks",
        "add another Actor only when the requirement establishes concurrent",
