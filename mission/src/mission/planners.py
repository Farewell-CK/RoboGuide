...
class MissionPlanner(Protocol):
    ...
    def plan(self, mission_id: str, objective: str) -> MissionPlan:
        """Plan one mission or raise a typed configuration, provider, or contract error."""
        ...
...
class FixturePlanner:
    ...
    def plan(self, mission_id: str, objective: str) -> MissionPlan:
        """Load and validate a fixture, rejecting a request that targets another mission."""
