...
- `../contracts/mission/v0.5/`：Python 与 Rust 共同遵守、含 Context/ContextRole、role
  ...
  relative Task timing 的当前 MissionPlan Schema；v0.3/v0.4 继续作为兼容输入；
- `../contracts/mission/request-v0.1/` 与 `inventory-v0.1/`：文本请求状态投影（可恢复嵌入
  v0.3/v0.4、当前输出 v0.5）和只读
