...
public final class NativeOctomap {
    ...
    public static native void nativeDecodePidNet(ByteBuffer logits, int classCount, int plane,
                                                  ...
                                                  float[] confidence);
    public static native void nativeDecodePidNetParallel(ByteBuffer logits, int classCount, int plane,
            int[] classMap, int[] mask, float[] confidence, boolean parallel);
